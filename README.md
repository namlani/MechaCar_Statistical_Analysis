...
![image](https://user-images.githubusercontent.com/5934390/123319702-bf3a9000-d4fe-11eb-8bab-0b97c313a3ae.png)
...
1. The design specifications for the MechaCar suspension coils dictate that the variance of the suspension coils must not exceed 100 pounds per square inch. Does the current manufacturing data meet this design specification for all manufacturing lots in total and each lot individually? Why or why not?
   - Although the total variance at 76.23 does meet the design specification of 100, when looking closer at the data, Lot3 exceeds the specification with a variance of 220.
